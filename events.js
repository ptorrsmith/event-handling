...
function three() {
  ...
  // three.addEventListener('mouseenter', makeColor('orange', event));
  // three.addEventListener('mouseleave', makeColor('white', event));
...
function toggleBlack(evt) {
  ...
  if (eventElement.style.backgroundColor == "black") {
    makeWhite(evt);
  } else {
